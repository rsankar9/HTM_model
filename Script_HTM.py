import HTM_binary_distinct

# # # For a single run:
file_count = 1
resFile = "Run" + str(file_count) + ".json"
HTM_binary_distinct.HTM(resFile)
...
#     flagGot = HTM_binary_distinct.HTM(resFile, training_sequences, testing_sequences)
#     if flagGot == True:
...
#     flagGot = HTM_binary_distinct.HTM(resFile, training_sequences[num], testing_sequences[num])
#     if flagGot == True:
...
# #       flagBoth = HTM_binary_s_free.HTM(resFile, d, d*150)
# #       if flagBoth == True:
